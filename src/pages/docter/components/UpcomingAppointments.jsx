        ...
        if (action === "approve") {
          ...
          if (appointmentData.videoCallLink) {
            if (emailSent) {
              ...
              toast.warning(
                `Appointment approved and video link generated, but the email was not sent. Check backend email settings.`,
                {
                  duration: 6000,
                }
              );
          ...
          if (emailSent) {
            ...
            toast.warning(
              `Appointment declined, but the email was not sent. Check backend email settings.`
            );
          }
        }
