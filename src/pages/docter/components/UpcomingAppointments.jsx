...
import { Calendar, Clock, Video, ExternalLink, CheckCircle, X, Eye, RefreshCw, CalendarDays } from 'lucide-react';
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium">Loading upcoming appointments...</p>
        </div>
      </div>
    );
  }
