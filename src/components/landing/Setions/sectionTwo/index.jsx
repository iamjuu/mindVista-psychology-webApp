...
const SectionTwo = () => {
  ...
  return (
    <Container bg={'#1d1614'}>
      <ContainerWrap  >
        <Main>
          <div className="left" data-aos='fade-down' data-aos-delay="1000">
            <h3 data-aos='fade-left' data-aos-delay="1000">{sectionTwoData.left[0].h3}</h3>
          ...
          <div className="right" data-aos="fade-left">
            {sectionTwoData.right.map((data) => (
              <FreeContainer width={'290px'} key={data.id} data-aos="zoom-in">
                <div className="right-sub" style={{ transition: 'transform 0.3s ease' }}>
                  <h3 data-aos='fade-down' data-aos-delay="1500">{data.title}</h3>
                  <hr data-aos='fade-down' data-aos-delay="1600" style={{ width: '150px', opacity: '50%' }} />
                  <p data-aos='fade-down' data-aos-delay="1200">{data.p}</p>
                </div>
              </FreeContainer>
            ))}
          </div>
