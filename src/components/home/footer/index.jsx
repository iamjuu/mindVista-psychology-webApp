...
const Footer = () => {
  ...
  return (
    <>
      <div className="w-full bg-white text-black mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 sm:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1 xl:col-span-1">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center">
                ...
                <span>support@mindvista.com</span>
              </div>
              <div className="flex items-center">
                <svg
                  className="w-4 h-4 text-secondary mr-3 flex-shrink-0"
          ...
          <div className="sm:col-span-2 text-black lg:col-span-1 xl:col-span-1">
            <h2 className="text-black font-[500] text-[18px] sm:text-lg mb-3 sm:mb-4">
              Follow Us
            </h2>
            <nav className="space-y-2 text-sm">
              <a
          ...
          {/* Newsletter */}
          <div className="sm:col-span-2 lg:col-span-1 xl:col-span-1">
            <h1 className="text-black font-[500] text-[18px] sm:text-lg mb-3 sm:mb-4">
              Join Our Newsletter
            </h1>
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              ...
              <button
                ...
                className="w-full bg-[#E53935] text-white border  px-4 py-2.5 rounded-xl hover:bg-[#d92f2c] hover:text-white transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              >
                {isSubmitting ? (
                  <>
                    <svg
      ...
      {/* Toast Notification */}
      {showToast && (
        <div className="fixed top-5 right-6 bg-green-500 text-white px-4 py-3 rounded-md shadow-lg flex items-center space-x-2 animate-fadeIn">
          <svg
